...
#Model file
stan.model.file = "gp_envelope.stan"
...
stan.data = list(N = N,
                 ...
                 sigma_prior_shape = 1,
                 sigma_prior_rate = 1,
                 alpha_delta_prior_sd = 1,
                 P_inv_diag_delta_prior_shape = 1,
                 P_inv_diag_delta_prior_rate = 1,
                 sigma_delta_prior_shape = 1,
                 sigma_delta_prior_rate = 1,
                 log_delta_mean = -25)
...
stan.fit = stan(stan.model.file, data = stan.data,
                ...
                pars = c("K", "K_delta"), include = FALSE,
